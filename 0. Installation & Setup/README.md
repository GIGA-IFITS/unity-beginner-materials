...
A step-by-step installation & setup guide for Unity version 6.<br>
...
![Unity Homepage](resources/unity-homepage.jpg)
  > ⚠ If a login page shows up, please login or create an account first ⚠
- Download Unity Hub Installer
![Unity Download Page](resources/unity-download-page.jpg)
...
![Unity Hub Setup](resources/unityHub-setup.jpg)
...
![Unity Hub Setup](resources/unityHub-installed.jpg)
...
![Unity Hub Setup](resources/unityHub-installOptions.jpg)
...
![Unity Hub Setup](resources/unityHub-installModules.jpg)
...
![Unity Hub Setup](resources/unityHub-installing.jpg)
- If you need to install additional modules, you can access the 'Add Modules' window here.
![Unity Hub Add Modules](resources/unityHub-addModules.jpg)
## 3. Licenses
...
![Unity Licenses](resources/unityHub-licenses.jpg)
- Choose the 'free personal license' option.
![Unity License Options](resources/unityHub-licenseOptions.jpg)
- You need to agree to the terms and condition of getting the license.
![Unity License Agreement](resources/unityHub-licenseAgreement.jpg)
...
![Unity Setup Project](resources/unityHub-setupProject.jpg)
